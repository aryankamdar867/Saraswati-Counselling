...
export default function StudentPredictionRequestModal({ isOpen, onClose }: StudentPredictionRequestModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-amber-500/30 rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-8 text-slate-900 dark:text-white transition-colors">
        {/* Background glow */}
        ...
        {submitted ? (
          <div className="text-center py-6 space-y-4">
            <div className="w-16 h-16 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/40 rounded-full flex items-center justify-center mx-auto shadow-lg shadow-emerald-500/20">
            ...
            <div className="bg-amber-50 dark:bg-slate-800/80 rounded-2xl p-4 border border-amber-500/30 text-left text-xs space-y-2 text-slate-700 dark:text-slate-300">
              <div className="flex items-start gap-2">
                <Mail className="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                <span>
                  Your official <strong>Branded Prediction PDF</strong> will be delivered directly to <strong className="text-slate-900 dark:text-white font-mono">{formData.email}</strong>.
                </span>
              </div>
              <div className="flex items-start gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 py-3 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white text-center transition-all shadow-md"
              >
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl text-xs font-semibold bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700"
              >
                Close
              </button>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 mb-1">
              ...
              <span className="text-xs font-semibold tracking-wider uppercase">Free AI Prediction PDF • Zero Cost</span>
            </div>
            <h2 className="text-2xl font-bold font-serif text-slate-900 dark:text-amber-100 mb-1.5">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3 py-2 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-amber-400"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-amber-400"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 px-3 py-2 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-amber-400 font-bold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-amber-400"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-amber-400"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-xl font-bold bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 shadow-lg shadow-amber-500/25 transition-all text-sm flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
